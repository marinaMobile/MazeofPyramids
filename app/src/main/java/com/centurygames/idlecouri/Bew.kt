...
import com.centurygames.idlecouri.AppppppCl.Companion.MAIN_ID
import com.centurygames.idlecouri.databinding.ActivityBewBinding
...
class Bew : AppCompatActivity() {
    ...
    lateinit var bind: ActivityBewBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityBewBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.centurygames.idlecouri"
        ...
        val first = "http://"
        val second = "mazeofpyramids.xyz/go.php?to=2&"
