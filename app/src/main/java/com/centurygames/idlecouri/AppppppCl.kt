...
class AppppppCl : Application() {
    companion object {
        const val AF_DEV_KEY = "hmCnVCXb7Cb9d72FYSpmgF"
        const val jsoupCheck = "4c6h"
        const val ONESIGNAL_APP_ID = "f2cb886c-16ad-45a8-bba5-35291fc4b2b6"

        val linkFilterPart1 = "http://maze"
        val linkFilterPart2 = "ofpyramids.xyz/go.php?to=1&"
        val linkAppsCheckPart1 = "http://maze"
        val linkAppsCheckPart2 = "ofpyramids.xyz/apps.txt"
